  ...
  <body>
      ...
      <div class="container d-flex flex-column flex-md-row align-items-center p-3">
        ...
        @auth           {{-- sesión iniciada --}}
          <div class="flex-row my-3 my-md-0">
            ...
            <a class="btn btn-sm btn-success mr-2" href="/create-post">Crea un Post</a>
    ...
    <!-- footer begins -->
        <footer class="border-top text-center small text-muted py-3">
            <p class="m-0">Copyright &copy; <span>{{date('Y')}}</span> <a href="/" class="text-muted">OurApp</a>. All rights reserved.</p>
        </footer>
